 ...
 * @see com.mobile_16thnov.test_16thnov.Table2
 */
@Service("Test_16thNov.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("Test_16thNov.Table2Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Table2Id> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "Test_16thNovTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "Test_16thNovTransactionManager")
    @Override
