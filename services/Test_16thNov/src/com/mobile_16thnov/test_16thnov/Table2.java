...
@ManyToOne(fetch=FetchType.EAGER)
    @JoinColumns( { 
        @JoinColumn(name="COLUMN2", referencedColumnName="COLUMN2", nullable=false, insertable=false, updatable=false), 
        @JoinColumn(name="COLUMN3", referencedColumnName="ID", nullable=false, insertable=false, updatable=false) } )
